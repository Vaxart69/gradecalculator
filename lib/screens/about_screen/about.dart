            ...
            child: Column(
              ...
              children: [
                ...
                _CustomPurpleButton(
                  ...
                  backgroundColor: const Color(0xFF6200EE), // Purple
                ),
                Padding(
                ...
                _CustomPurpleButton(
                  ...
                  width: size.width * 0.8,
                  height: size.height * 0.06,
                  backgroundColor: const Color(0xFFCF6C79), // Red
                ),
                SizedBox(height: height * 0.02),
              ],
            ),
  ...
  Future<void> _handleDeleteAccount() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        if (result == null) {
          // Success - navigate to starting page
...
Widget _AboutContent(double height) {
  return Column(
    ...
    children: [
      ...
      SizedBox(height: height * 0.02),
      Text(
        "Disclaimer: This app rounds grades using the .5-up, .4-down rule, which may not reflect your course's exact grading policy.",
        style: GoogleFonts.poppins(
          color: Color(0xFFCF6C79),
